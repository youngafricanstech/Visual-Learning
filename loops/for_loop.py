...
# pygame.display.set_caption("Animate Vertical Line Example")
...
# # Calculate initial line position at the center
# line_x = width // 2 - line_width // 2
# line_start = (line_x, (height - line_height) // 2)

# # Animation variables
# decrease_animation = True
...
#     # Adjust line height based on animation state
#     if decrease_animation:
#         line_height = max(line_height // 3, 120)
#     else:
#         line_height = 360

#     # Toggle animation state
#     decrease_animation = not decrease_animation

#     # Calculate line end position
#     line_end = (line_x, (height - line_height) // 2)

#     # Draw the animated vertical line
...
#     # Cap the frame rate
#     pygame.time.Clock().tick(1)  # 1 frame per second for the animation
...
while running:
    ...
    vertical_line_width = 6  # Adjust the width of the line
   ...
   # make this line to stretch to the location of the draw_jumping_object each time it moves
    ...
    horizontal_line_height = 6  # Adjust the height of the line
