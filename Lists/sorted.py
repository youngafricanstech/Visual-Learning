...
pygame.display.set_caption("Sort Fruits List")
...
def sort_list():
    fruits_data.fruits = sorted(fruits_data.fruits, key=lambda x: x.name.lower())
    # update_listbox()

# Create Tkinter window
root = Tk()
root.title("Sort Fruits List GUI")

# Button to sort the list
sort_button = Button(root, text="Sort List", command=sort_list, font=("Arial", 16))
sort_button.pack()
